...
export default function ListProposalCode(props: any) {
  return (
    <div className='whitespace-nowrap text-left rounded-lg overflow-hidden w-full bg-white dark:bg-neutral-900 p-2 border border-gray-100 dark:border-neutral-800 relative'>
      ...
      <div className='mt-5 space-y-1.5 px-5 pb-5'>
        ...
        <p className='my-4 pb-4 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-700'>const </span>
          <span className='text-neutral-800 dark:text-gray-300'>
            proposals ={' '}
          </span>
          <span className='text-neutral-700'>await </span>
          <span className='text-gray-300'>{`fetchProposals`}</span>
          <span className='text-neutral-500'>{`();`}</span>
        </p>
        ...
        <p className='ml-6 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-700'>{`<Proposal.List `}</span>
          <span className='text-neutral-800 dark:text-gray-300'>{`view`}</span>
          <span className='text-neutral-700'>{`=`}</span>
          <span className='text-indigo-400'>{`'${props.view}'`}</span>
          <span className='text-neutral-700'>{`>`}</span>
        </p>
        <p className='ml-9 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-800 dark:text-gray-300'>{`{proposals.map(proposal => (`}</span>
        </p>
        <p className='ml-12 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-700'>{`<Proposal.Item {`}</span>
          <span className='text-gray-300'>{`...proposal`}</span>
          <span className='text-neutral-700'>{`}`}</span>
        </p>
        <p className='ml-9 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-800 dark:text-gray-300'>{`)}`}</span>
        </p>
        <p className='ml-6 font-mono text-sm tracking-wide text-violet-400'>
          <span className='text-neutral-700'>{`</Proposal.List>`}</span>
        </p>
